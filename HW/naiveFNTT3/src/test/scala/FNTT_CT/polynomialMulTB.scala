...
class polynomialMulTB extends AnyFlatSpec with ChiselScalatestTester {
  ...
  it should "polynomialMul ex" in {
    test(new polynomialMul(width = 8)).withAnnotations(Seq(WriteVcdAnnotation)) { p =>
      ...
      //Data Injecton
      p.io.inData(0)(0).poke(1.U(8.W))
      p.io.inData(0)(1).poke(1.U(8.W))
      p.io.inData(0)(2).poke(1.U(8.W))
      p.io.inData(0)(3).poke(1.U(8.W))
      ...
      //Data Injecton
      p.io.inData(1)(0).poke(0.U(8.W))
      p.io.inData(1)(1).poke(0.U(8.W))
      p.io.inData(1)(2).poke(0.U(8.W))
      p.io.inData(1)(3).poke(0.U(8.W))
      p.io.inData(1)(4).poke(1.U(8.W))
      p.io.inData(1)(5).poke(1.U(8.W))
      p.io.inData(1)(6).poke(1.U(8.W))
      p.io.inData(1)(7).poke(1.U(8.W))

      p.clock.step(50)

      p.io.outData(0).expect(3.U(8.W))
      p.io.outData(1).expect(2.U(8.W))
      p.io.outData(2).expect(1.U(8.W))
      p.io.outData(3).expect(0.U(8.W))
      p.io.outData(4).expect(1.U(8.W))
      p.io.outData(5).expect(2.U(8.W))
      p.io.outData(6).expect(3.U(8.W))
      p.io.outData(7).expect(4.U(8.W))
