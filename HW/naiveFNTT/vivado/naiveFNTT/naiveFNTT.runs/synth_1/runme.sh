...
HD_PWD='C:/File/zkp/Lab/NTT-study/HW/naiveFNTT/vivado/naiveFNTT/naiveFNTT.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log reverse_bits_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source reverse_bits_tb.tcl
